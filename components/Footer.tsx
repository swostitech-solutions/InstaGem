  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800 py-6 px-4 text-center text-gray-400 text-xs">
      <div className="max-w-2xl mx-auto space-y-3">
        ...
        <p>
          All educational videos are embedded from their original sources on
          YouTube. We do not host, own, or claim any rights to the content.
        </p>
        ...
        <p className="text-xs text-gray-500 mt-4">
          © 2025 InstaGem. All videos remain property of their respective
          creators.
        </p>
